    ...
    <div class="carnets-container">
        ...
        foreach ($carnets as $index => $carnet) {
            ...
            foreach ($carnet['images'] as $img) {
                echo '<img src="image/' . htmlspecialchars($img) . '" alt="' . htmlspecialchars($carnet['title']) . '">';
            }
    ...
    <section class="experiences">
        ...
        foreach ($experiences as $experience) {
            ...
            foreach ($experience['images'] as $i => $img) {
                echo '<img src="image/' . htmlspecialchars($img) . '" alt="Expérience à ' . htmlspecialchars($experience['location']) . '" onclick="openLightbox(' . $i . ')">';
            }
